...
<!-- Grade 4 , Semester 1 , Chapter 9 , Number 5 -->
...
<html>
    <head>
        ...
        <script>
            ...
            function check_nick()
            {
                window.open("check_id.php?id="+document.member_form.id.value, "NICKcheck", "left=200, top=200, width=200, height=60, scrollbars=no, resizable=yes");
            }
                            ...
                            <div id="join2">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        - <input type="text" class="hp" name="hp2"> - <input type="text" id="hp" name="hp3">
                                    </li>
                                    <li>
